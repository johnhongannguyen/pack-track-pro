    ...
    <>
      ...
      <main>
        <section id="center">
          ...
          <p>
            Total Package: {filteredSearch.length}{" "}
            {filteredSearch.length === 1 ? "case" : "cases"}
          </p>
          ...
          <div className="package-list">
            ...
            {filteredSearch.length === 0 ? (
              ...
              >
                <p>
                  No packing found matching "<strong>{searchTerm}</strong>"
                </p>
                <button
              ...
              <table>
                ...
                <tbody>
                  {filteredSearch.map((batch) => {
                    ...
                    const isExpiredSoon =
                      expiredDate >= today && expiredDate <= sevenDaysFromNow;
                          ...
                          style={{
                            color: isExpired
                              ...
                              : isExpiredSoon
                                ...
                                : "inherit",
                            fontWeight:
                              isExpired || isExpiredSoon ? "bold" : "normal",
                          }}
                        >
                          {batch.expiry}{" "}
                          {isExpired ? "(EXPIRED)" : isExpiredSoon ? "(!)" : ""}
                        </td>
                        <td
                          style={{
                            color:
                              ...
                              batch.status === "Shipped"
                                ...
                                : batch.status === "In Progress"
                                  ...
                                  : "inherit",
                            fontWeight:
                              batch.status === "Pending" ? "bolder" : "normal",
                          }}
                        >
                          {batch.status}
                        </td>
